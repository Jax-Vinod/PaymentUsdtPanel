            ...
            <div id="menu" role="navigation">
                <vmenu>
                    <vsub-menu title="Dashboards" icon="fa fa-home">
                        <vmenu-item link="/" icon="fa fa-angle-double-right"><span class="txt_dash">Dashboard 1</span>
                        </vmenu-item>
                    ...
                    <vsub-menu title="Forms" icon="fa fa-pencil-square-o icon_pencil">
                        ...
                        <vmenu-item link="/form_validations" icon="fa fa-angle-double-right">Form validations
                        </vmenu-item>
                    ...
                    <vsub-menu title="Files" icon="fa fa-file-o icon_file">
                        <vmenu-item link="/multi_file_upload" icon="fa fa-angle-double-right">Multi file upload
                        </vmenu-item>
                        ...
                        <vmenu-item link="/vue_draggable" icon="fa fa-angle-double-right">Vue Draggable</vmenu-item>
